...
func NewCustomRichMemo(AOwner IComponent) ICustomRichMemo {
	r1 := LCL().SysCallN(2167, GetObjectUintptr(AOwner))
	return AsCustomRichMemo(r1)
}

func (m *TCustomRichMemo) ZoomFactor() (resultDouble float64) {
	LCL().SysCallN(2202, 0, m.Instance(), uintptr(unsafePointer(&resultDouble)), uintptr(unsafePointer(&resultDouble)))
	return
}

func (m *TCustomRichMemo) SetZoomFactor(AValue float64) {
	LCL().SysCallN(2202, 1, m.Instance(), uintptr(unsafePointer(&AValue)), uintptr(unsafePointer(&AValue)))
}

func (m *TCustomRichMemo) CanRedo() bool {
	r1 := LCL().SysCallN(2164, m.Instance())
	return GoBool(r1)
}

func (m *TCustomRichMemo) Transparent() bool {
	r1 := LCL().SysCallN(2201, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TCustomRichMemo) SetTransparent(AValue bool) {
	LCL().SysCallN(2201, 1, m.Instance(), PascalBool(AValue))
}

func (m *TCustomRichMemo) CanPaste() bool {
	r1 := LCL().SysCallN(2163, m.Instance())
	return GoBool(r1)
}

func (m *TCustomRichMemo) GetTextAttributes(TextStart int32, TextParams *TFontParams) bool {
	var result1 uintptr
	r1 := LCL().SysCallN(2176, m.Instance(), uintptr(TextStart), uintptr(unsafePointer(&result1)))
...
func (m *TCustomRichMemo) GetStyleRange(CharOfs int32, RangeStart, RangeLen *int32) bool {
	var result1 uintptr
	var result2 uintptr
	r1 := LCL().SysCallN(2175, m.Instance(), uintptr(CharOfs), uintptr(unsafePointer(&result1)), uintptr(unsafePointer(&result2)))
...
func (m *TCustomRichMemo) GetParaAlignment(TextStart int32, AAlign *TParaAlignment) bool {
	var result1 uintptr
	r1 := LCL().SysCallN(2168, m.Instance(), uintptr(TextStart), uintptr(unsafePointer(&result1)))
	*AAlign = TParaAlignment(result1)
	return GoBool(r1)
}

func (m *TCustomRichMemo) GetParaAlignment1(TextStart int32) TParaAlignment {
	r1 := LCL().SysCallN(2169, m.Instance(), uintptr(TextStart))
	return TParaAlignment(r1)
}

func (m *TCustomRichMemo) GetParaMetric(TextStart int32, AMetric *TParaMetric) bool {
	var result1 uintptr
	r1 := LCL().SysCallN(2170, m.Instance(), uintptr(TextStart), uintptr(unsafePointer(&result1)))
...
func (m *TCustomRichMemo) GetParaNumbering(TextStart int32, ANumber *TParaNumbering) bool {
	var result1 uintptr
	r1 := LCL().SysCallN(2171, m.Instance(), uintptr(TextStart), uintptr(unsafePointer(&result1)))
...
func (m *TCustomRichMemo) GetParaRange(CharOfs int32, ParaRange *TParaRange) bool {
	var result1 uintptr
	r1 := LCL().SysCallN(2172, m.Instance(), uintptr(CharOfs), uintptr(unsafePointer(&result1)))
...
func (m *TCustomRichMemo) GetParaRange1(CharOfs int32, TextStart, TextLength *int32) bool {
	var result1 uintptr
	var result2 uintptr
	r1 := LCL().SysCallN(2173, m.Instance(), uintptr(CharOfs), uintptr(unsafePointer(&result1)), uintptr(unsafePointer(&result2)))
...
func (m *TCustomRichMemo) GetParaTabs(CharOfs int32, AStopList *TTabStopList) bool {
	var result1 uintptr
	r1 := LCL().SysCallN(2174, m.Instance(), uintptr(CharOfs), uintptr(unsafePointer(&result1)))
	*AStopList = *(*TTabStopList)(getPointer(result1))
	return GoBool(r1)
}

func (m *TCustomRichMemo) IsLink(TextStart int32) bool {
	r1 := LCL().SysCallN(2181, m.Instance(), uintptr(TextStart))
	return GoBool(r1)
}

func (m *TCustomRichMemo) LoadRichText(Source IStream) bool {
	r1 := LCL().SysCallN(2182, m.Instance(), GetObjectUintptr(Source))
	return GoBool(r1)
}

func (m *TCustomRichMemo) SaveRichText(Dest IStream) bool {
	r1 := LCL().SysCallN(2185, m.Instance(), GetObjectUintptr(Dest))
	return GoBool(r1)
}

func (m *TCustomRichMemo) InDelText(UTF8Text string, InsStartChar, ReplaceLength int32) int32 {
	r1 := LCL().SysCallN(2180, m.Instance(), PascalStr(UTF8Text), uintptr(InsStartChar), uintptr(ReplaceLength))
	return int32(r1)
}

func (m *TCustomRichMemo) InDelInline(inlineobj IRichMemoInline, InsStartChar, ReplaceLength int32, ASize *TSize) int32 {
	r1 := LCL().SysCallN(2179, m.Instance(), GetObjectUintptr(inlineobj), uintptr(InsStartChar), uintptr(ReplaceLength), uintptr(unsafePointer(ASize)))
	return int32(r1)
}

func (m *TCustomRichMemo) GetTextForString(TextStart, TextLength int32) string {
	r1 := LCL().SysCallN(2177, m.Instance(), uintptr(TextStart), uintptr(TextLength))
	return GoStr(r1)
}

func (m *TCustomRichMemo) GetUText(TextStart, TextLength int32) string {
	r1 := LCL().SysCallN(2178, m.Instance(), uintptr(TextStart), uintptr(TextLength))
	return GoStr(r1)
}

func (m *TCustomRichMemo) Search(ANiddle string, Start, Len int32, SearchOpt TSearchOptions) int32 {
	r1 := LCL().SysCallN(2186, m.Instance(), PascalStr(ANiddle), uintptr(Start), uintptr(Len), uintptr(SearchOpt))
	return int32(r1)
}
...
func (m *TCustomRichMemo) Search1(ANiddle string, Start, Len int32, SearchOpt TSearchOptions, ATextStart, ATextLength *int32) bool {
	var result3 uintptr
	var result4 uintptr
	r1 := LCL().SysCallN(2187, m.Instance(), PascalStr(ANiddle), uintptr(Start), uintptr(Len), uintptr(SearchOpt), uintptr(unsafePointer(&result3)), uintptr(unsafePointer(&result4)))
...
func (m *TCustomRichMemo) Print(params *TPrintParams) int32 {
	r1 := LCL().SysCallN(2183, m.Instance(), uintptr(unsafePointer(params)))
	return int32(r1)
}

func (m *TCustomRichMemo) CharAtPos(x, y int32) int32 {
	r1 := LCL().SysCallN(2165, m.Instance(), uintptr(x), uintptr(y))
	return int32(r1)
}
...
func (m *TCustomRichMemo) SetTextAttributes(TextStart, TextLen int32, TextParams *TFontParams) {
	LCL().SysCallN(2199, m.Instance(), uintptr(TextStart), uintptr(TextLen), uintptr(unsafePointer(TextParams)))
}

func (m *TCustomRichMemo) SetParaAlignment(TextStart, TextLen int32, AAlign TParaAlignment) {
	LCL().SysCallN(2190, m.Instance(), uintptr(TextStart), uintptr(TextLen), uintptr(AAlign))
}

func (m *TCustomRichMemo) SetParaMetric(TextStart, TextLen int32, AMetric *TParaMetric) {
	LCL().SysCallN(2191, m.Instance(), uintptr(TextStart), uintptr(TextLen), uintptr(unsafePointer(AMetric)))
}

func (m *TCustomRichMemo) SetParaNumbering(TextStart, TextLen int32, ANumber *TParaNumbering) {
	LCL().SysCallN(2192, m.Instance(), uintptr(TextStart), uintptr(TextLen), uintptr(unsafePointer(ANumber)))
}

func (m *TCustomRichMemo) SetParaTabs(TextStart, TextLen int32, AStopList *TTabStopList) {
	LCL().SysCallN(2193, m.Instance(), uintptr(TextStart), uintptr(TextLen), uintptr(unsafePointer(AStopList)))
}

func (m *TCustomRichMemo) SetTextAttributes1(TextStart, TextLen int32, AFont IFont) {
	LCL().SysCallN(2200, m.Instance(), uintptr(TextStart), uintptr(TextLen), GetObjectUintptr(AFont))
}

func (m *TCustomRichMemo) SetRangeColor(TextStart, TextLength int32, FontColor TColor) {
	LCL().SysCallN(2194, m.Instance(), uintptr(TextStart), uintptr(TextLength), uintptr(FontColor))
}
...
func (m *TCustomRichMemo) SetRangeParams(TextStart, TextLength int32, ModifyMask TTextModifyMask, FontName string, FontSize int32, FontColor TColor, AddFontStyle, RemoveFontStyle TFontStyles) {
	LCL().SysCallN(2196, m.Instance(), uintptr(TextStart), uintptr(TextLength), uintptr(ModifyMask), PascalStr(FontName), uintptr(FontSize), uintptr(FontColor), uintptr(AddFontStyle), uintptr(RemoveFontStyle))
}
...
func (m *TCustomRichMemo) SetRangeParams1(TextStart, TextLength int32, ModifyMask TTextModifyMask, fnt *TFontParams, AddFontStyle, RemoveFontStyle TFontStyles) {
	LCL().SysCallN(2197, m.Instance(), uintptr(TextStart), uintptr(TextLength), uintptr(ModifyMask), uintptr(unsafePointer(fnt)), uintptr(AddFontStyle), uintptr(RemoveFontStyle))
}

func (m *TCustomRichMemo) SetRangeParaParams(TextStart, TextLength int32, ModifyMask TParaModifyMask, ParaMetric *TParaMetric) {
	LCL().SysCallN(2195, m.Instance(), uintptr(TextStart), uintptr(TextLength), uintptr(ModifyMask), uintptr(unsafePointer(ParaMetric)))
}

func (m *TCustomRichMemo) SetLink(TextStart, TextLength int32, AIsLink bool, ALinkRef string) {
	LCL().SysCallN(2188, m.Instance(), uintptr(TextStart), uintptr(TextLength), PascalBool(AIsLink), PascalStr(ALinkRef))
}

func (m *TCustomRichMemo) SetSelLengthFor(aselstr string) {
	LCL().SysCallN(2198, m.Instance(), PascalStr(aselstr))
}

func (m *TCustomRichMemo) Redo() {
	LCL().SysCallN(2184, m.Instance())
}
...
func (m *TCustomRichMemo) SetOnSelectionChange(fn TNotifyEvent) {
	...
	LCL().SysCallN(2189, m.Instance(), m.selectionChangePtr)
}
